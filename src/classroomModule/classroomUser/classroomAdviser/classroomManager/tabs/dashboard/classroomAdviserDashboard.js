...
import { getMySubscriptions, getClassroomPlans } from '../../../../../../store/subscriptionSlice';
	...
	return (
		<>
			...
			<div class='grid grid-cols-4 gap-4'>
				<div className='storage' style={{ maxHeight: '350px', minHeight: '350px' }}>
				...
				{subscriptions[0] && (
					<div class='col-span-3 px-1 overflow-y-auto'>
						<NewBannerComponent
							title={subscriptions[0].plan.name ? subscriptions[0].plan.name : ''}
